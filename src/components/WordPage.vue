...
<div class="container-fluid">
  ...
  <div class="row">
    ...
    <div class="col-sm-7 wordpage-list-wrap" v-if="records.length > 0" ref="wordListWrap">
      ...
      <div class="wordcard" ref="wordcard" v-if="wordcardData" :style="{transform: `translateY(${wordcardTop}px)`}">
        ...
        <div class="wordcard-section-wrap" :style="{height: wordcardTransHeight + 'px'}">
