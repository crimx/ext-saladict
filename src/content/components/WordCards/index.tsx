  ...
  render () {
    ...
    return (
      <aside className='wordCards'>
        <header>
          <h1 className='wordCards-Title'>{t('wordEditorWordCardsTitle')}</h1>
        </header>
            ...
            >
              ...
              {word.trans &&
                <div className='wordCards-CardItem'>
                  <svg className='wordCards-CardItem_Icon' width='18' height='18' xmlns='http://www.w3.org/2000/svg' viewBox='0 0 469.333 469.333'>
                    <title>{t('wordEditorNoteTrans')}</title>
              ...
              {word.context &&
                <div className='wordCards-CardItem'>
                  <svg className='wordCards-CardItem_Icon' width='18' height='18' xmlns='http://www.w3.org/2000/svg' viewBox='0 0 95.333 95.332'>
                    <title>{t('wordEditorNoteContext')}</title>
              ...
              {word.note &&
                <div className='wordCards-CardItem'>
                  <svg className='wordCards-CardItem_Icon' width='18' height='18' xmlns='http://www.w3.org/2000/svg' viewBox='0 0 35.738 35.738'>
                    <title>{t('wordEditorNoteNote')}</title>
...
export default translate()(WordCards)
