...
export interface OptionsBtnProps extends MenubarBtnProps {
 ...
 * Options Button
 */
export const OptionsBtn: FC<OptionsBtnProps> = props => (
  <button
    className="menuBar-Btn"
    title={props.t('tip.openOptions')}
    disabled={props.disabled}
    onClick={props.onClick}
...
export const FavBtn: FC<FavBtnProps> = props => (
  <button
    className="menuBar-Btn"
    title={props.t('tip.addToNotebook')}
    disabled={props.disabled}
    onClick={props.onClick}
    onMouseDown={props.onMouseDown}
  >
    <svg
      className={`menuBar-Btn_Icon-fav${props.isFav ? ' isActive' : ''}`}
      width="30"
      height="30"
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 32 32"
...
export const PinBtn: FC<PinBtnProps> = props => (
  ...
  >
    ...
    >
      <path
        className={`menuBar-Btn_Icon-pin${props.isPinned ? ' isActive' : ''}`}
