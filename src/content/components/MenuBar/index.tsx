...
export default class MenuBar extends React.PureComponent<MenuBarProps> {
  ...
  render () {
    ...
    return (
      <header className='panel-MenuBar'>
        ...
        <svg
          className={`panel-MenuBar_IconPin ${isPinned ? 'is-Active' : ''}`}
          width='30' height='30' xmlns='http://www.w3.org/2000/svg' viewBox='0 0 53.011 53.011'
          onClick={pinPanel}
        >
          <title>Pin the panel</title>
