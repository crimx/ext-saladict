    ...
    <div class="urban-item" v-for="def in result">
      ...
      <footer class="footer">
        ...
        <span class="thumbs" v-if="def.thumbsUp">
          <svg class="icon-thumbs-up" xmlns="http://www.w3.org/2000/svg" width="561" height="561" viewBox="0 0 561 561">
        ...
        <span class="thumbs" v-if="def.thumbsDown">
          <svg class="icon-thumbs-down" xmlns="http://www.w3.org/2000/svg" width="561" height="561" viewBox="0 0 561 561">
